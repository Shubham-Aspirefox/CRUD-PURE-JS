...
function insertNewRecord(data) {
    ...
    cell4.innerHTML = `<button onClick="onEdit(this)" class="bg-success text-light border-0 rounded-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit</button>
